...
{
    public partial class People_test : Form
    {
        ...
        private void People_test_Load(object sender, EventArgs e)
        {
            connection = new MySqlConnection("datasource=localhost;port=3306;database=trivio_learn;username=root;password=nov23dku");
            connection.Open();
            string str = "SELECT * FROM terms_vocabulary WHERE vocabulary_category='people' ORDER BY RAND() LIMIT 10";
