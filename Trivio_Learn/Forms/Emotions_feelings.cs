...
{
    public partial class Emotions_feelings : Form
    {
        ...
        private void Emotions_feelings_Load(object sender, EventArgs e)
        {
            ...
            string selectQuery = "SELECT term, audio_path, description FROM terms_vocabulary WHERE id_vocabulary = 9";
