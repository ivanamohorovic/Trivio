...
{
    public partial class Travel_tourism : Form
    {
        ...
        private void Travel_tourism_Load(object sender, EventArgs e)
        {
            ...
            string selectQuery = "SELECT term, audio_path, description FROM terms_vocabulary WHERE id_vocabulary = 13";
