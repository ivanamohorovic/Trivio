...
{
    public partial class Leisure_time : Form
    {
        ...
        private void Leisure_time_Load(object sender, EventArgs e)
        {
            ...
            string selectQuery = "SELECT term, audio_path, description FROM terms_vocabulary WHERE id_vocabulary = 12";
