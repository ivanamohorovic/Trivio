...
{
    public partial class Health_Care : Form
    {
        ...
        private void Health_Care_Load(object sender, EventArgs e)
        {
            ...
            string selectQuery = "SELECT term, audio_path, description FROM terms_vocabulary WHERE id_vocabulary = 8";
