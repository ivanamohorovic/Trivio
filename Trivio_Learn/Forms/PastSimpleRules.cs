...
{
    public partial class PastSimpleRules : Form
    {
        public PastSimpleRules()
        {
            InitializeComponent();
        }
        ...
        private void bunifuFlatButton4_Click(object sender, EventArgs e)
        {
            ...
            panelChildFormPastSimpleRules.Controls.Add(myResult);
            panelChildFormPastSimpleRules.Tag = myResult;
