...
{
    public partial class Celebrations : Form
    {
        ...
        private void Celebrations_Load(object sender, EventArgs e)
        {
            ...
            string selectQuery = "SELECT term, audio_path, description FROM terms_vocabulary WHERE id_vocabulary = 16";
