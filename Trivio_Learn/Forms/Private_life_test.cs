...
{
    public partial class Private_life_test : Form
    {

        public static List<string> list;

        public Private_life_test()
        {
            InitializeComponent();
        ...
        private void Private_life_test_Load(object sender, EventArgs e)
        {

            connection = new MySqlConnection("datasource=localhost;port=3306;database=trivio_learn;username=root;password=nov23dku");
            connection.Open();
            string str = "SELECT * FROM terms_vocabulary WHERE vocabulary_category='private_life' ORDER BY RAND() LIMIT 10";
        ...
        private void bunifuFlatButton4_Click(object sender, EventArgs e)
        {
            ...
            Result_common myResult = new Result_common();
            myResult.Graph(broj);
