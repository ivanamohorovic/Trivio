...
{
    public partial class ExerGoingTo : Form
    {
        public ExerGoingTo()
        {
            InitializeComponent();
        ...
        private void ExerGoingTo_Load(object sender, EventArgs e)
        {
            ...
            while (reader.Read())
            {
                ...
                else
                {
                    ...
                    txtBox[counter].Name = reader["id_sentence"].ToString();
                    txtBox[counter].Visible = true;
                    txtBox[counter].Size = new Size(160, 24);
                    ...
                    lbl3[counter].AutoSize = true;
                    lbl3[counter].Visible = true;
                    lbl3[counter].Location = new Point(240, 10 + space);
                    lbl3[counter].Font = new Font("Century Gothic", 12);
                    lbl3[counter].ForeColor = Color.LightCyan;
                    panel1.Controls.Add(lbl3[counter]);
        ...
        private void bunifuFlatButton1_Click(object sender, EventArgs e)
        {
            ...
            Trivio_Learn.Forms.Result_grammar myResult = new Forms.Result_grammar();
            myResult.graph(broj);
