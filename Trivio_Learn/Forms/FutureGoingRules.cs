...
{
    public partial class FutureGoingRules : Form
    {
        public FutureGoingRules()
        {
            InitializeComponent();
        }
        ...
        private void bunifuFlatButton4_Click(object sender, EventArgs e)
        {
            ...
            panelChildFormFutureGoingRules.Controls.Add(myResult);
            panelChildFormFutureGoingRules.Tag = myResult;
